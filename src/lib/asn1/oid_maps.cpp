...
* OID maps
*
* This file was automatically generated by src/scripts/oids.py on 2023-01-11
*
...
std::unordered_map<std::string, std::string> OIDS::load_oid2str_map()
   ...
   return std::unordered_map<std::string,std::string>{
      ...
      { "1.3.6.1.4.1.25258.1.10.1", "Dilithium-AES-r3/4x4-randomized" },
      { "1.3.6.1.4.1.25258.1.10.2", "Dilithium-AES-r3/4x4-deterministic" },
      { "1.3.6.1.4.1.25258.1.10.3", "Dilithium-AES-r3/6x5-randomized" },
      { "1.3.6.1.4.1.25258.1.10.4", "Dilithium-AES-r3/6x5-deterministic" },
      { "1.3.6.1.4.1.25258.1.10.5", "Dilithium-AES-r3/8x7-randomized" },
      { "1.3.6.1.4.1.25258.1.10.6", "Dilithium-AES-r3/8x7-deterministic" },
      ...
      { "1.3.6.1.4.1.25258.1.9.1", "Dilithium-r3/4x4-randomized" },
      { "1.3.6.1.4.1.25258.1.9.2", "Dilithium-r3/4x4-deterministic" },
      { "1.3.6.1.4.1.25258.1.9.3", "Dilithium-r3/6x5-randomized" },
      { "1.3.6.1.4.1.25258.1.9.4", "Dilithium-r3/6x5-deterministic" },
      { "1.3.6.1.4.1.25258.1.9.5", "Dilithium-r3/8x7-randomized" },
      { "1.3.6.1.4.1.25258.1.9.6", "Dilithium-r3/8x7-deterministic" },
...
std::unordered_map<std::string, OID> OIDS::load_str2oid_map()
   ...
   return std::unordered_map<std::string,OID>{
      ...
      { "Dilithium-AES-r3/4x4-deterministic", OID({1,3,6,1,4,1,25258,1,10,2}) },
      { "Dilithium-AES-r3/4x4-randomized", OID({1,3,6,1,4,1,25258,1,10,1}) },
      { "Dilithium-AES-r3/6x5-deterministic", OID({1,3,6,1,4,1,25258,1,10,4}) },
      { "Dilithium-AES-r3/6x5-randomized", OID({1,3,6,1,4,1,25258,1,10,3}) },
      { "Dilithium-AES-r3/8x7-deterministic", OID({1,3,6,1,4,1,25258,1,10,6}) },
      { "Dilithium-AES-r3/8x7-randomized", OID({1,3,6,1,4,1,25258,1,10,5}) },
      { "Dilithium-r3/4x4-deterministic", OID({1,3,6,1,4,1,25258,1,9,2}) },
      { "Dilithium-r3/4x4-randomized", OID({1,3,6,1,4,1,25258,1,9,1}) },
      { "Dilithium-r3/6x5-deterministic", OID({1,3,6,1,4,1,25258,1,9,4}) },
      { "Dilithium-r3/6x5-randomized", OID({1,3,6,1,4,1,25258,1,9,3}) },
      { "Dilithium-r3/8x7-deterministic", OID({1,3,6,1,4,1,25258,1,9,6}) },
      { "Dilithium-r3/8x7-randomized", OID({1,3,6,1,4,1,25258,1,9,5}) },
