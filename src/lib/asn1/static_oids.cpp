/*
* This file was automatically generated by src/scripts/dev_tools/gen_oids.py on 2026-09-25
...
std::optional<std::string_view> OID_Map::lookup_static_oid(const OID& oid) {
   ...
   switch(hc) {
      ...
      case 0x27566:
         return if_match(oid, {1, 3, 6, 1, 5, 5, 7, 48, 1, 2}, "PKIX.OCSP.Nonce");
      case 0x27569:
      ...
      case 0x6F553:
         return if_match(oid, {1, 3, 6, 1, 4, 1, 25258, 1, 19, 1}, "HQC-1");
      case 0x6F555:
         return if_match(oid, {1, 3, 6, 1, 4, 1, 25258, 1, 19, 3}, "HQC-3");
      case 0x6F557:
         return if_match(oid, {1, 3, 6, 1, 4, 1, 25258, 1, 19, 5}, "HQC-5");
      case 0x6F79D:
      ...
      case 0x7F41D:
         return if_match(oid, {2, 5, 29, 56}, "X509v3.NoRevocationAvailable");
      case 0x80B84:
      ...
      case 0x94CEE:
         return if_match(oid, {1, 3, 6, 1, 5, 5, 7, 8, 9}, "PKIX.SmtpUTF8Mailbox");
      case 0x954DB:
...
std::optional<OID> OID_Map::lookup_static_oid_name(std::string_view req) {
   ...
   switch(hc) {
      ...
      case 0x282FE:
         return if_match(req, "PKIX.OCSP.Nonce", {1, 3, 6, 1, 5, 5, 7, 48, 1, 2});
      case 0x29999:
      ...
      case 0x8BB11:
         return if_match(req, "X509v3.NoRevocationAvailable", {2, 5, 29, 56});
      case 0x8CE3D:
      ...
      case 0xA373F:
         return if_match(req, "HQC-1", {1, 3, 6, 1, 4, 1, 25258, 1, 19, 1});
      case 0xA3741:
         return if_match(req, "HQC-3", {1, 3, 6, 1, 4, 1, 25258, 1, 19, 3});
      case 0xA3743:
         return if_match(req, "HQC-5", {1, 3, 6, 1, 4, 1, 25258, 1, 19, 5});
      case 0xA3C55:
